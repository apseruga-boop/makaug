  ...
  <main id="page-advertise" class="page active" data-public-route="/advertise">
    ...
    <section class="bg-[#0f3d2e] py-10 text-white">
      <div class="max-w-5xl mx-auto px-4">
        ...
        <p class="text-green-50 mt-3 max-w-3xl">Pick a placement, choose duration, generate an on-brand ad, preview it, then use hosted PayPal or Uganda mobile-money/card checkout. King approves before it goes live.</p>
      ...
      <form id="advertising-selfserve-form" onsubmit="submitAdvertisingSelfServeCampaign(event)" class="rounded-3xl border border-green-100 bg-white p-4 md:p-5">
        ...
        <div class="grid lg:grid-cols-[1.05fr_0.95fr] gap-5">
          <div class="space-y-4">
            ...
            <section data-ad-ss-step="5" class="hidden space-y-3"><h3 class="font-black text-gray-900">5. Pay</h3><div class="grid md:grid-cols-2 gap-3"><input id="advertising-ss-name" class="rounded-xl border border-gray-200 px-4 py-3 text-sm" placeholder="Your name" required><input id="advertising-ss-business" class="rounded-xl border border-gray-200 px-4 py-3 text-sm" placeholder="Business / brand"><input id="advertising-ss-email" type="email" class="rounded-xl border border-gray-200 px-4 py-3 text-sm" placeholder="Email"><input id="advertising-ss-phone" class="rounded-xl border border-gray-200 px-4 py-3 text-sm" placeholder="WhatsApp / phone"></div><div class="grid sm:grid-cols-3 gap-2"><label class="rounded-xl border border-green-200 bg-green-50 px-3 py-3 text-sm font-bold"><input type="radio" name="advertising-ss-payment" value="paypal" checked> PayPal</label><label class="rounded-xl border border-gray-200 px-3 py-3 text-sm font-bold"><input type="radio" name="advertising-ss-payment" value="mobile_money"> MTN/Airtel Mobile Money</label><label class="rounded-xl border border-gray-200 px-3 py-3 text-sm font-bold"><input type="radio" name="advertising-ss-payment" value="card"> Card</label></div><p class="text-xs text-gray-500">Card and mobile-money details stay inside the hosted payment flow.</p></section>
