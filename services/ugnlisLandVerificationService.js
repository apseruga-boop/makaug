...
function buildUgNlisAssistantReply({ language = 'en', baseUrl = 'https://makaug.com' } = {}) {
  ...
  const lines = {
    en: [
      ...
      '',
      'makaug can help you prepare the title details, store the search-letter evidence, and connect the evidence back to the listing.',
      '',
    ...
    lg: [
      ...
      '',
      'makaug esobola okukuyamba okutegeka ebikwata ku title, okutereka evidence ya search letter, n’okugikwataganya ne listing.',
      '',
    ...
    sw: [
      ...
      '',
      'makaug inaweza kusaidia kuandaa maelezo ya hati, kuhifadhi ushahidi wa search letter, na kuunganisha ushahidi huo na listing.',
      '',
