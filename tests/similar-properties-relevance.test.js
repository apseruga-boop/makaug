...
assert(markerCount >= 1, "production HTML must retain the similar relevance marker as release diagnostics");
...
assert(recallMarkerCount >= 1, "production HTML must retain the similar recall marker as release diagnostics");
...
assert(aliasRenderMarkerCount >= 1, "production HTML must retain the similar alias/render marker as release diagnostics");
...
assert(purposeFallbackMarkerCount >= 1, "production HTML must retain the similar purpose fallback marker as release diagnostics");
...
assert(hydrationResponseMarkerCount >= 1, "production HTML must retain the similar hydration response marker as release diagnostics");
...
assert(explicitCategoryMarkerCount >= 1, "production HTML must retain the similar explicit category marker as release diagnostics");
...
assert(hydrationFallbackMarkerCount >= 1, "production HTML must retain the similar hydration fallback marker as release diagnostics");
...
assert(endpointFallbackMarkerCount >= 1, "production HTML must retain the similar endpoint fallback marker as release diagnostics");
...
assert(hydrationDiagnosticsMarkerCount >= 1, "production HTML must retain the similar hydration diagnostics marker as release diagnostics");
...
assert(pathTitleFallbackMarkerCount >= 1, "production HTML must retain the similar path title fallback marker as release diagnostics");
...
assert(directDetailObjectMarkerCount >= 1, "production HTML must retain the similar direct detail object marker as release diagnostics");
...
assert(textSourceFallbackMarkerCount >= 1, "production HTML must retain the similar text source fallback marker as release diagnostics");
...
assert(hydrationAttemptMarkerCount >= 1, "production HTML must retain the similar hydration attempt marker as release diagnostics");
...
assert(skeletonMarkerCount >= 1, "production HTML must retain the similar skeleton marker as release diagnostics");
