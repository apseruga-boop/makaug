...
function run() {
  ...
  assert(frontendSource.includes('id="account-access-create-broker-id-step"') && frontendSource.includes('broker_identity_document_url') && frontendSource.includes('broker_data_retention_notice_accepted'), 'broker account drawer should require National ID upload and data-retention notice before password creation');
