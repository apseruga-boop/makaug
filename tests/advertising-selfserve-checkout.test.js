...
assert(app.includes('is saved for review') && selfServeSource.includes('contentTemplate("advertise.savedForReview"'), 'self-serve should explain that the campaign enters review in the selected language');
assert(app.includes('only after payment'), 'self-serve should explain the live payment gate');
