...
function applySouthAfricaJavaScript(source) {
  ...
  let output = String(source || '')
    ...
    .replace(/\bMakerere\b/g, 'University of Cape Town')
    .replace(/\bKololo\b/g, 'Rosebank')
    .replace(/\bBukoto\b/g, 'Green Point')
    ...
    .replace(/\bKyambogo\b/g, 'University of Johannesburg')
    .replace(/\bMUBS\b/g, 'Wits University')
