...
| Field agents | `/admin/field-agents`, `/admin/contracts` | `/api/admin/field-agents/provision`, field-agent dashboard APIs | Create Field Agent ID + PIN, performance table | hashed PIN only, activity/audit logs | Working for admin-created agents |
