...
const keywordMap: Array<{ intent: TopLevelIntent; keywords: string[] }> = [
  ...
  { intent: 'advertising_campaign', keywords: ['advertise', 'boost', 'sponsor', 'campaign', 'paid ad', 'ad slot', 'homepage banner', 'whatsapp campaign', 'rate card'] },
  { intent: 'property_listing', keywords: ['list property', 'post property', 'sell my house', 'i want to list'] },
        ...
        input: [
          {
            role: 'system',
            content:
              'Classify the user request into exactly one intent from: property_search, property_listing, advertising_campaign, agent_search, agent_registration, mortgage_help, account_help, saved_properties, support, report_listing, looking_for_property_lead, unknown. Return JSON {"intent":"..."}.'
          },
