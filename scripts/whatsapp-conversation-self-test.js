...
const scenarios = [
  ...
  {
    name: 'Voice note transcript is echoed then answered in detected language',
    messages: [
      {
    ...
    expectLast: {
      includes: ['Umesema', 'Natafuta nyumba ya kupangisha Kampala'],
      excludes: ['You said', 'I heard', 'Sorry, something went wrong']
    }
  },
  {
