...
function sourceWiringChecks() {
  ...
  const expectations = [
    ...
    ['frontend hero hides commercial bedrooms', 'index.html', 'commercial: { propertyLabelKey: "heroCommercialType", showBedrooms: false'],
    ['frontend hero hides land bedrooms', 'index.html', 'land: { propertyLabelKey: "heroLandType", showBedrooms: false'],
