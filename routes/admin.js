...
function providerConfigured(provider) {
  const keyGroups = {
    ...
    payment_link: ['PAYMENT_LINK_BASE_URL', 'PAYMENT_PROVIDER_API_KEY', 'PAYMENT_PROVIDER_WEBHOOK_SECRET', 'FLUTTERWAVE_SECRET_KEY', 'FLUTTERWAVE_WEBHOOK_SECRET', 'FLUTTERWAVE_SECRET_HASH'],
...
function providerEnvKeys(provider) {
  const keyGroups = {
    ...
    payment_link: ['PAYMENT_PROVIDER', 'UGANDA_PAYMENT_PROVIDER', 'PAYMENT_LINK_BASE_URL', 'PAYMENT_PROVIDER_API_KEY', 'PAYMENT_PROVIDER_WEBHOOK_SECRET', 'FLUTTERWAVE_SECRET_KEY', 'FLUTTERWAVE_PUBLIC_KEY', 'FLUTTERWAVE_ENCRYPTION_KEY', 'FLUTTERWAVE_WEBHOOK_SECRET', 'FLUTTERWAVE_SECRET_HASH'],
